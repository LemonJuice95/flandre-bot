...
public class DisableFunctionCommand extends GroupCommandRunner {
    ...
    public boolean validate() {
        ...
        return message.startsWith(CQCodeUtils.at(this.command.selfId) + "/禁用功能");
    }
    ...
    public void apply() {
        ...
        if(FunctionNameManager.GROUP_FUNCTIONS.containsKey(funcMessage)) {
            ...
            SendingUtils.sendGroupText(this.command.groupId, CQCodeUtils.reply(this.command.messageId) + "已禁用功能 " + funcMessage);
        } else {
